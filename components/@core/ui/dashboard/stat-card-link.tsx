...
export const StatCardLink = ({ children, path = '/admin' }: StatCardLinkProps) => {
  return (
    <Link href={path} className='text-[0.8rem] relative group text-muted-foreground hover:text-foreground transition-all ease-in-out duration-300 font-medium flex items-center justify-center mr-4 gap-2'>
      {children}
